...
const MOCK_PRODUCTS: Product[] = [
  ...
  { id: "7", title: "Locking Snapback", price: 10, category: "Apparel", image: "https://placehold.co/400x400/1a1a2e/3b82f6?text=🧢+Snapback" },
  { id: "8", title: "Battle Mix Tape", price: 3, category: "Music", image: "https://placehold.co/400x400/1a1a2e/f43f5e?text=📼+Mix" },
  { id: "9", title: "Floor Work Knee Pads", price: 18, category: "Gear", image: "https://placehold.co/400x400/1a1a2e/14b8a6?text=🛡️+Pads", badge: "Essential" },
  { id: "10", title: "Voguing Bracelet Set", price: 6, category: "Accessories", image: "https://placehold.co/400x400/1a1a2e/d946ef?text=💎+Bracelets" },
];
    ...
    <div className="space-y-5 sm:space-y-8">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-muted-foreground">Dance merch marketplace — powered by your agent</p>
        </div>
      </div>
          ...
          <Card key={product.id} className="overflow-hidden bg-gradient-card">
            ...
            <CardContent className="p-4 space-y-3">
              <div className="flex items-start justify-between gap-2">
                <h3 className="font-display font-semibold text-foreground leading-tight">{product.title}</h3>
